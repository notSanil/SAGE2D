...
all: $(SOURCE) $(SCENE_MANAGER) $(ANIMATOR) $(CAMERA) $(RENDERER) $(OBJECTFACTORY) $(SCENEFACTORY) $(TEXT) $(POINT) 
	g++ -o $(OUTPUT) $(SOURCE) $(SCENE_MANAGER) $(ANIMATOR) $(CAMERA) \
$(RENDERER) $(TEXT) $(OBJECTFACTORY) $(SCENEFACTORY) $(POINT) $(OBJECTS) $(SCENES)  $(LINKER)
